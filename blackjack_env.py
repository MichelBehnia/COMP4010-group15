...
class BlackjackEnv(gym.Env):
    ...
    def _draw_card(self) -> int:
        ...
        return min(card, 10)  # J, Q, K all become 10
    ...
    def reset(self, seed: Optional[int] = None, options: Optional[Dict[str, Any]] = None) -> Tuple[Tuple[int, int, int], Dict]:
        ...
        self.first_action = True  # Reset for new game
        
        # Reset insurance tracking
        self.insurance_taken = False
    ...
    def step(self, action: int) -> Tuple[Tuple[int, int, int], float, bool, bool, Dict]:
        ...
        # insurance case
            ...
            if dealer_natural:
                ...
                # Net insurance result: +1.0 payout - 0.5 cost = +0.5
    ...
    def _step_split_hand(self, action: int) -> Tuple[Tuple[int, int, int], float, bool, bool, Dict]:
        terminated = False
        truncated = False
        reward = 0.0
